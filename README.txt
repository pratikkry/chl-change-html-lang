...
Tags: html, doctype, language attributes, html lang, header, chl-change-html-lang, seo plugin, pzerone
...
You can't change HTML language attribute directly so I created this plugin(CHL-Change HTML Lang) that allow you to change HTML language attribute from the dashboard.
...
== Upgrade Notice ==
= 1.0 =
Initial Release. Visit Settings → General after activating.
= 1.0.1 =
* Small bug fixed
= 1.0.2 =
* Bug Fixed
